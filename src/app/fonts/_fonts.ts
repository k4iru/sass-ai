...
export const firaSans = localFont({
	src: [
		{
			path: "./fira/FiraSans-LightItalic.woff2",
			weight: "300",
			style: "italic",
		},
		{
			path: "./fira/FiraSans-ExtraLight.woff2",
			weight: "200",
			style: "normal",
		},
		{
			path: "./fira/FiraSans-ExtraBold.woff2",
			weight: "700",
			style: "normal",
		},
		{
		...
		{ path: "./fira/FiraSans-Italic.woff2", weight: "400", style: "italic" },
		{
			path: "./fira/FiraSans-BoldItalic.woff2",
			weight: "700",
			style: "italic",
		},
		{ path: "./fira/FiraSans-Black.woff2", weight: "900", style: "normal" },
		{
			path: "./fira/FiraSans-BlackItalic.woff2",
			weight: "900",
			style: "italic",
		},
		...
		{ path: "./fira/FiraSans-Bold.woff2", weight: "700", style: "normal" },
		{
			path: "./fira/FiraSans-Regular.woff2",
			weight: "normal",
			style: "normal",
		},
		...
		{
			path: "./fira/FiraSans-ThinItalic.woff2",
			weight: "100",
			style: "italic",
		},
		{
