...
--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN "tokens" smallint NOT NULL;--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN "provider" varchar(100) NOT NULL;--> statement-breakpoint
